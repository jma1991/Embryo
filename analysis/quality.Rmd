...
```{r}
sce <- cbind(read_rds(here("data/MA0001.Rds")), read_rds(here("data/MA0002.Rds")))
```
...
patchwork::wrap_plots(
  plotColData(sce, x = "genotype", y = "log10_total_counts"),
  plotColData(sce, x = "genotype", y = "log10_total_features_by_counts"),
  plotColData(sce, x = "genotype", y = "pct_counts_MT"),
  ncol = 2
)
```
...
```{r}
qc1 <- sce$log10_total_counts < 3.25
qc2 <- sce$log10_total_features_by_counts < 3.25
qc3 <- sce$pct_counts_MT > 5
sce$manual <- !(qc1 | qc2 | qc3)
```
...
```{r, fig.height = 9, fig.width = 10}
patchwork::wrap_plots(
    plotColData(sce, x = "genotype", y = "log10_total_counts", colour_by = "manual"),
    plotColData(sce, x = "genotype", y = "log10_total_features_by_counts", colour_by = "manual"),
    plotColData(sce, x = "genotype", y = "pct_counts_MT", colour_by = "manual"),
    ncol = 2
)
```
...
qc3 <- isOutlier(sce$pct_counts_MT, nmads = 3, type = "higher", batch = sce$genotype)
sce$adaptive <- !(qc1 | qc2 | qc3)
```
...
```{r, fig.height = 9, fig.width = 10}
patchwork::wrap_plots(
    plotColData(sce, x = "genotype", y = "log10_total_counts", colour_by = "adaptive"),
    plotColData(sce, x = "genotype", y = "log10_total_features_by_counts", colour_by = "adaptive"),
    plotColData(sce, x = "genotype", y = "pct_counts_MT", colour_by = "adaptive"),
    ncol = 2
)
```
...
```{r}
run <- runColDataPCA(sce, outliers = TRUE, variables = c("log10_total_counts", "log10_total_features_by_counts", "pct_counts_MT"))
...
```{r, fig.height = 9, fig.width = 10}
patchwork::wrap_plots(
    plotColData(sce, x = "genotype", y = "log10_total_counts", colour_by = "outlier"),
    plotColData(sce, x = "genotype", y = "log10_total_features_by_counts", colour_by = "outlier"),
    plotColData(sce, x = "genotype", y = "pct_counts_MT", colour_by = "outlier"),
    ncol = 2
)
```
